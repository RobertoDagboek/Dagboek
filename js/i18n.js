...
const STRINGS = {
  af: {
    ...
    'entry.locking': 'Kry ’n vasstelling… {acc}',
    'entry.copied': 'Koördinate gekopieer',
    'media.noLocation': 'Geen plek aan hierdie foto nie',
    'media.setLocation': '📍 Gebruik my plek',
    'media.relocate': '📍 Verander plek',
    'media.clearLocation': 'Verwyder plek',
    'media.located': 'Plek gestoor',
    'entry.tags': 'Etikette',
  ...
  en: {
    ...
    'entry.locking': 'Getting a fix… {acc}',
    'entry.copied': 'Coordinates copied',
    'media.noLocation': 'No location on this photo',
    'media.setLocation': '📍 Use my location',
    'media.relocate': '📍 Change location',
    'media.clearLocation': 'Remove location',
    'media.located': 'Location saved',
    'entry.tags': 'Tags',
